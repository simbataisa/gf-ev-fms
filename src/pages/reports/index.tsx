  ...
  const columns = [
    ...
    },
    {
        ...
        render: (_: unknown, record: Report) => (
          <span>
            {moment(record.startDate).format('YYYY-MM-DD')} to {moment(record.endDate).format('YYYY-MM-DD')}
          </span>
        ),
      },
    {
        ...
        <>
          ...
          >
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <Text>{moment(selectedReport.startDate).format('YYYY-MM-DD')} to {moment(selectedReport.endDate).format('YYYY-MM-DD')}</Text>
            </div>
            
            <div style={{ marginBottom: 16 }}>
              <Text strong>Generated By: </Text>
              <Text>{selectedReport.user ? `${selectedReport.user.firstName} ${selectedReport.user.lastName}` : 'Unknown User'}</Text>
            </div>
